                ...
                <div class="ibox-content">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="AddonMaster[name]" id="addontmaster-name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="AddonMaster[price]" id="addonmaster-price">
                            </div>
                        </div>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control selecttwo" id="states" name="AddonMaster[product_id]" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="AddonMaster[category]" id="addonmaster-category">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="radio-inline">
                                    <input type="radio" name="AddonMaster[is_active]" value="1" checked> Active
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="AddonMaster[is_active]" value="0"> Inactive
                                </label>
                            </div>
                        </div>
