...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <?php $form = ActiveForm::begin(['action' =>['addon-master/bulkdelete'], 'id' => 'administratorbulkdelete', 'method' => 'post',],['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="mb-md" style="float: right;">
                        ...
                        <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/addon-master/add" class="btn btn-success" style="margin-top: -8px;"><i class="fa fa-plus"></i>Add</a>
                    </div>
                </div>
                                        ...
                                        foreach($lists as $list)
                                        {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo Yii::$app->homeUrl.'admin/addon-master/edit-addon?id='.$list->id;?>" class="btn btn-primary btn-circle" title="EDIT"><i class="fa fa-edit"></i></a> | <a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/addon-master/delete-addon?id=<?php echo $list->id;?>" onClick="return confirm('Are you sure you want to delete?');" class="btn btn-danger btn-circle" title="DELETE"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            $increment++;
    ...
    $(document).ready(function(){
        ...
        $('.dataTables-zone-list').DataTable({
            ...
            buttons: [
                ...
                {extend: 'csv',title:'addonList',exportOptions: {
                    columns: [0,2,3,4,5]
                }},
                {extend: 'excel', title: 'addonList',exportOptions: {
                    columns: [0,2,3,4,5]
                }},
                {extend: 'pdf', title: 'addonList',exportOptions: {
                    columns: [0,2,3,4,5]
                }},
...
<script>
    $(document).ready(function () {
        $(".chng").on("change", function () {
            ...
            // alert(is_active);
            $.ajax({
                url: '<?php echo Yii::$app->request->baseUrl . '/admin/addon-master/status' ?>',
                type: 'post',
