...
<style type="text/css">
  /* Styles for fixed header and video */
  #fixed-header-video-container {
    position: fixed;
    top: 60px; /* Adjust this if your main header height is different */
    left: 0;
    width: 100%;
    z-index: 1000; /* High z-index to ensure it's on top */
    /* background-color: #fff; /* Optional: uncomment if a background is needed, e.g., if video is transparent or slow to load */
  }

  #fixed-header-video-container > marquee {
    display: block; /* Ensures it behaves as a block-level element */
    height: 30px; /* Define a fixed height for the marquee, adjust as needed */
    line-height: 30px; /* Helps vertically center text if marquee content is single line */
    margin-bottom: 0 !important; /* Overrides any inline margin-bottom and ensures no gap */
    width: 100%;
    /* The inline styles for background: darkred; color: yellow; from the original marquee tag will be preserved */
  }

  #video-background { /* This ID is already on the video tag */
    display: block; /* Removes potential extra space below the video if it were inline */
    width: 100%;
    height: 40vh; /* Video will take 40% of the viewport's height. Adjust as needed. */
    object-fit: cover; /* Ensures the video covers the allocated space, cropping if necessary to maintain aspect ratio */
  }

  .main-content {
    /* Adds padding to the top of .main-content to prevent its content from being hidden behind the fixed header/video.
       The value is the sum of the assumed main header height (60px), marquee height (30px) and video height (40vh). */
    padding-top: calc(60px + 30px + 40vh) !important; /* 60px is assumed main header height, adjust if needed. */
  }
...
<!-- Fixed Header and Video Container Start -->
<div id="fixed-header-video-container">
...
<!-- Fixed Header and Video Container End -->
<!-- Main content Start -->
<div class="main-content">
  ...
  <!-- Slider begins here -->
  <?php /* The marquee and video elements that were previously here (between lines 70-73 approx.)
     have been moved into the '#fixed-header-video-container' div above this 'main-content' div.
     This comment indicates the removal of:
     <marquee style="background: darkred;color: yellow; margin-bottom: -8px;">...</marquee>
     <video poster="..." id="video-background" ...>...</video>
  */ ?>
  <!-- Slider End -->
    ...
    <div class="container-fluid bg-gradient p-5 mob-ndis" >
      <div class="row m-auto text-center">
        <div class="col-md-12" data-loop="true" data-items="4" data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="false" data-ipad-device="3" data-ipad-device-nav="true" data-ipad-device-dots="false" data-ipad-device2="3" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="4" data-md-device-nav="true" data-md-device-dots="false">
            ...
            <div class="princing-item green">
              <div class="pricing-divider">
                ...
                <h4 class="my-0 display-4 text-light font-weight-normal" style="display: inline-block;">
                  <span class="h3">₹</span> 400<span class="h5"></span>
                </h4>
                <!--10% OFF Tag -->
                <span style="background: red; color: white; padding: 5px 10px; font-size: 14px; font-weight: bold; border-radius: 5px; margin-left: 10px;">
                  20% OFF
                </span>
              </div>
              <div class="card-body bg-white mt-0 shadow">
                <button type="button" style="background:#1AA85C; color:#fff;" class="btn btn-lg btn-block btn-custom" data-toggle="modal" data-target="#waterworldModal">
                  Book Now
                </button>
              </div>
            </div>
          ...
          <!--Dry Park Rides Tickets Combo-->

          <div class="team-item col-md-3 mb-3">
            <div class="princing-item green">
              <div class="pricing-divider">
                <h3 class="text-light">Dry Park Ride Combo</h3>
                <p class="text-light font-weight-normal" data-toggle="tooltip" title="Entry Fees + All Rides (once) ">Entry Fees + All Rides</p>
                <h4 class="my-0 display-4 text-light font-weight-normal"><span class="h3">₹</span> 200 <span class="h5">/per person</span></h4>
              </div>
              <div class="card-body bg-white mt-0 shadow">
