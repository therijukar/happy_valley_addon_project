            ...
            <div class="team-item">
               <div class="princing-item green">
                   <div class="pricing-divider">
                     ...
                     <p class="text-light font-weight-normal" data-toggle="tooltip" title="Entry Fees + All Rides (once) ">* Condition Apply</p>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
              <?php $form = ActiveForm::begin(['action' =>['booking/water-world'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal','id'=>"waterworld-form"]]); ?>
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabe2">Book Dry Park Rides Combo Ticket</h5>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
                 </button>
               </div>
               <div class="modal-body">
                   ...
                   <div class="form-group">
                     <input type="text" value="Dry Park Rides Combo Ticket" class="form-control" readonly>
