...
.ticketModal .form-group input.form-control:focus{
    ...
    right: 20px;
        ...
        <div class="pricing-divider">
            ...
            <p class="text-light font-weight-bold" data-toggle="tooltip" title="">Same Day Online Ticket Booking not allowed!</p>
        ...
        <div class="card-body bg-white mt-0 shadow">
           ...
           <br>
           <br>
           <div id="rs-team" class="sec-color" style="background:url(<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/bg/rides.png); background-repeat:no-repeat; background-size:cover; padding-bottom:50px; padding-top: 50%;">
             <div class="container">
