...
?>
<?php
// Fetch all pricing data indexed by product_code
$pricingData = \app\models\Pricing::find()->indexBy('product_code')->all();

function getDiscountLabel($model) {
    if (!empty($model->discount_label)) {
        return $model->discount_label;
    }
    if ($model->original_price > $model->price) {
        $percent = (($model->original_price - $model->price) / $model->original_price) * 100;
        // prevent 100% if price is not 0
        if ($percent > 99 && $model->price > 0) {
            $percent = 99;
        } else {
...
<div class="main-content">
  ...
  <!-- Slider begins here -->
  <marquee style="background: darkred;color: yellow; margin-bottom: -8px;">Entering the park under the influence of alcohol or with alcohol is strictly prohibited. Synthetic cloth is mandatory for the water park. Outside food is not allowed.</marquee>
  ...
  <section id="rs-services" class="rs-services-3 price mp-212" style="position: relative;background:url(<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/bg/rides.png); background-repeat:no-repeat; background-size:cover;">
    <div class="container-fluid bg-gradient p-5 mob-ndis" >
      <div class="row m-auto text-center">
        <div class="col-md-12 rs-carousel owl-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="4" data-md-device-nav="true" data-md-device-dots="false">
          <?php 
            // Define special modals for legacy products
            $specialModals = [
                9 => '#waterdryModal',
                8 => '#waterworldModal',
                6 => '#fiveDModal',
            ...
            // Loop through all pricing data
            foreach ($pricingData as $code => $model): 
                $modalId = $specialModals[$code] ?? '#ticketModal';
                $isGeneric = !isset($specialModals[$code]);
          ?>
            <div class="team-item mb-3" style="position: relative;">
                
                <?php $label = getDiscountLabel($model); ?>
                <?php if ($label): ?>
                <span style="
                    position: absolute;
                    top: -10px;
                ...
                <div class="princing-item green">
                    <div class="pricing-divider">
                        <h3 class="text-light"><?= Html::encode($model->name) ?></h3>
                        <p class="text-light font-weight-bold" data-toggle="tooltip" title="<?= Html::encode($model->description) ?>">
                            <?= nl2br(Html::encode($model->description)) ?>
                        </p>
                        
                        <?php if ($model->original_price > $model->price): ?>
                        <h3 style="display: inline-block; text-decoration: line-through; color: white; margin-right: 10px;">₹<?= $model->original_price ?></h3>
                        <?php endif; ?>
                        
                        <h4 class="my-0 display-4 text-light font-weight-normal" style="display: inline-block;">
                            <span class="h3"> ₹</span><?= $model->price ?><span class="h5"></span>
                        </h4>
                    </div>
                    <div class="card-body bg-white mt-0 shadow">
                        <button type="button" 
                                style="background:#1AA85C; color:#fff;" 
                                class="btn btn-lg btn-block btn-custom book-now-btn <?= $isGeneric ? 'generic-book-btn' : '' ?>" 
                                data-toggle="modal" 
                                data-target="<?= $modalId ?>" 
          ...
          <!--Water Park Ticket Booking Commented-->

          <!--<div class="team-item ">-->
          <!--   <div class="princing-item green">-->
          <!--       <div class="pricing-divider">-->
          <!--         <h3 class="text-light">Dry Park Rides Combo</h3>-->

          <!--         <span style="color: red; font-weight: bold; text-shadow: -2px -2px 0 white, 2px -2px 0 white, -2px 2px 0 white, 2px 2px 0 white; font-family: Arial, sans-serif; font-size: 30px; margin-top: -10px;">Entry Fee + All Rides</span>-->


          <!--         <p class="text-light font-weight-normal" data-toggle="tooltip" title="Enjoy All Rides One time only">*All Rides Once</p> -->
          ...
          <!--         <h4 class="my-0 display-4 text-light font-weight-normal" style="display: inline-block;"><span class="h3">₹</span> 200<span class="h5"></span></h4>-->
          ...
          <!--We disable the entry ticket for not working reason!-->
          <!--<div class="team-item col-md-3 mb-3">-->
          ...
          <div class="team-item col-md-3 mb-3" style="display:none">
            <div class="princing-item green">
              <div class="pricing-divider">
              ...
              <div class="card-body bg-white mt-0 shadow">
                ...
                <button type="button" style="background:#1AA85C; color:#fff;" class="btn btn-lg btn-block btn-custom" data-toggle="modal" data-target="#fiveDModa">Book Now</button>
              </div>
            </div>
          </div>
          <div class="team-item col-md-3 mb-3" style="display:none">
  ...
  <div id="rs-team" class="sec-color" style="background:url(<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/bg/rides.png); background-repeat:no-repeat; background-size:cover; padding-bottom:50px; ">
    <div class="container">
      ...
      <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="70" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="true" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="true" data-md-device-dots="false">
        ...
        <div class="team-item">
          <div class="team-overlay">
            <div class="team-img" style="position: relative;">
              <img src="<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/team/frisbee.jpg" alt="" />
              <div style="position: absolute; top: 10px; left: 10px; background-color: red; color: white; padding: 5px 10px; border-radius: 5px; font-size: 12px; font-weight: bold;">
                New Ride
              </div>
            </div>
          </div>
          <div class="team-info">
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/frisbee">
        ...
        <div class="team-item">
          <div class="team-overlay">
            <div class="team-img" style="position: relative;">
              <img src="<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/team/flyingcarousel.jpg" alt="" />
              <div style="position: absolute; top: 10px; left: 10px; background-color: red; color: white; padding: 5px 10px; border-radius: 5px; font-size: 12px; font-weight: bold;">
                New Ride
              </div>
            </div>
          ...
          <div class="team-info">
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/jumping-house">
              <h4 class="title"><strong>Flying Carousel</strong></h4>
            </a>
            <p>With every bounce there is a whole new experience waiting for your little ones. Put some bounce into your kid’s routine with this enormous, inflatable, exciting experience.</p>
          </div>
        </div>
        ...
        <div class="team-item">
          <div class="team-overlay">
            <div class="team-img" style="position: relative;">
              <img src="<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/horserides.jpg" alt="" />
              <div style="position: absolute; top: 10px; left: 10px; background-color: red; color: white; padding: 5px 10px; border-radius: 5px; font-size: 12px; font-weight: bold;">
                New Ride
              </div>
            </div>
          ...
          <div class="team-info">
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/jumping-house">
              <h4 class="title"><strong>Horse Ride</strong></h4>
            </a>
            <p>With every bounce there is a whole new experience waiting for your little ones. Put some bounce into your kid’s routine with this enormous, inflatable, exciting experience.</p>
          </div>
        </div>
        ...
        <div class="team-item">
          <div class="team-overlay">
            <div class="team-img" style="position: relative;">
              <img src="<?php echo Yii::getAlias('@web') . '/web/assets/' ?>images/toytrain.jpg" alt="" />
              <div style="position: absolute; top: 10px; left: 10px; background-color: red; color: white; padding: 5px 10px; border-radius: 5px; font-size: 12px; font-weight: bold;">
                New Ride
              </div>
            </div>
          ...
          <div class="team-info">
            <a href="<?php echo Yii::$app->request->baseUrl; ?>/jumping-house">
              <h4 class="title"><strong>Toy Train</strong></h4>
            </a>
            <p>With every bounce there is a whole new experience waiting for your little ones. Put some bounce into your kid’s routine with this enormous, inflatable, exciting experience.</p>
          </div>
        </div>
        ...
        <div class="team-item">
          ...
          <div class="team-info"> <a href="<?php echo  Yii::$app->request->baseUrl; ?>/waterworld">
      ...
      <div class="col-md-7">
        <div class="container">
          <div class="wow fadeIn exp_pad" data-wow-duration="1s" data-wow-delay=".2s">
            ...
            <a href="<?php echo  Yii::$app->request->baseUrl; ?>/theatre" style="background:#A72BC9; padding: 6px 50px;; color:#fff; border-radius:0;" class="btn">Read More</a>
          </div>
        </div>
      </div>
...
<!-- Model Starts Here -->
             ...
             <div class="modal-content">
              <?php $form = ActiveForm::begin(['action' =>['enquiry/add-enquiry'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_1" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly1" name="Enquiry[from_date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
              ...
              <?php $form = ActiveForm::begin(['action' =>['enquiry/add-enquiry'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_1" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly2" autocomplete="off" name="Enquiry[from_date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
 ...
 <?php $form = ActiveForm::begin(['action' =>['booking/add-tickets'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal','id'=>"booking-form"]]); ?>
							...
							<div class="row">								
								...
								<div class="col-lg-6">
									<div class="form-group data_1" id="">
										<div class="input-group datereadonlydiv">
											<span class="input-group-addon"></span>
											<input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly3" autocomplete="off" name="Booking[date]" required readonly>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
        ...
        <!-- Model For Ticket Booking -->
              ...
              <?php $form = ActiveForm::begin(['action' =>['booking/add-tickets'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_1" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly5" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
                     <input type="number" id="people2" name="Booking[no_of_units]" class="form-control" min="1" placeholder="No of People" required>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
              <?php $form = ActiveForm::begin(['action' =>['booking/fived-booking'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal','id'=>"fived-form"]]); ?>
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabe2">Book Dry Park Ride Combo</h5>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
                 </button>
               </div>
               ...
               <div class="row">								
                ...
                <div class="form-group data_2" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly6" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                <div class="form-group">
                     <input type="text" value="Book Dry Park Ride Combo" class="form-control" readonly>
              ...
              <?php $form = ActiveForm::begin(['action' =>['booking/full-package'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_1" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly7" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
              ...
              <?php $form = ActiveForm::begin(['action' =>['booking/water-world'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal','id'=>"waterworld-form"]]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_3" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly8" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                     <input type="text" value="Water World Ticket Booking" class="form-control" readonly>
         ...
         <!-- waterdryModal -->
         <div class="modal fade ticketModal" id="waterdryModal" tabindex="-1" role="dialog" aria-labelledby="ticketModalLabel" aria-hidden="true">
           <div class="modal-dialog" role="document">
             <div class="modal-content">
              <?php $form = ActiveForm::begin(['action' =>['booking/water-dry-combo'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal','id'=>"waterdry-form"]]); ?>
               <div class="modal-header">
                 <h5 class="modal-title" id="exampleModalLabe2">Book Water + Dry Combo Ticket</h5>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
                 </button>
               </div>
               <div class="modal-body">
                   ...
                   <div class="form-group data_3" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly88" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
                     <input type="number" id="people111" name="Booking[belowtenyears]" class="form-control" min="1" placeholder="No of People Below 10 Years">
                   </div>
                   <div class="form-group">
                     <input type="number" id="people121" name="Booking[abovetenyears]" class="form-control" min="1" placeholder="No of People Above 10 Years" required>
                   </div>
                   <div class="form-group">
                     <input type="number" id="amount41" class="form-control" placeholder="Amount" readonly>
                   </div>
                   <div class="form-group">
                     <input type="text" value="Water Dry Combo Ticket Booking" class="form-control" readonly>
                     <input type="hidden" id="amt41" name="Booking[amount]" value="" class="form-control" readonly>
                     <input type="hidden" id="productid5" name="Booking[product]" value="9" class="form-control">
                   </div>
                   </div>
                   <div class="modal-footer">
                     <button type="submit" class="btn btn-primary" title="On Submit, Your Ticket Will Be Booked And You Will Receive An Email For The Same.">Submit
              ...
              <?php $form = ActiveForm::begin(['action' =>['booking/resturant-booking'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_1" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control" autocomplete="off" placeholder="Date" id="datereadonly9" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
              ...
              <?php $form = ActiveForm::begin(['action' =>['booking/picnicspot-booking'],'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
               ...
               <div class="modal-body">
                   ...
                   <div class="form-group data_1" id="">
                      <div class="input-group datereadonlydiv">
                          <span class="input-group-addon"></span>
                          <input type="text" class="form-control picnicdate" autocomplete="off" placeholder="Date" id="datereadonly10" autocomplete="off" name="Booking[date]" required readonly>
                      </div>
                   </div>
                   <div class="form-group">
    ...
    $(document).ready(function() {
        // Handle generic booking button click
        $('.generic-book-btn').click(function() {
            var productId = $(this).data('product-id');
            var productName = $(this).data('product-name');
            var modal = $('#ticketModal');
            
            // Set the product ID in the hidden field of the generic modal
            modal.find('input[name="Booking[product]"]').val(productId);
            
            // Optional: Update title or other visual cues
            modal.find('.modal-title').text('Book Ticket: ' + productName);
        });
    });
</script>
...
// Utility to handle form redirection
function handleBookingRedirect(data) {
    ...
    const targetUrl = '<?= \Yii\helpers\Url::to(['client/book']) ?>';
    
    if (token) {
        window.location.href = targetUrl;
    } else {
        const loginUrl = '<?= \Yii\helpers\Url::to(['client/login']) ?>';
        window.location.href = loginUrl + '?returnUrl=' + encodeURIComponent(targetUrl);
    }
}

$(document).ready(function() {
    // Interceptor for 5D Show
    $('#fived-form').on('submit', function(e) {
        e.preventDefault();
        e.stopImmediatePropagation();
        
        const value = $(`#datereadonly6`).val();
        if (!value) { alert(`Please select a date`); return false; }
    
        handleBookingRedirect({
            product: 6,
            date: value,
            name: $('input[name="Booking[name]"]', this).val(),
            phone: $('input[name="Booking[phone]"]', this).val(),
            email: $('input[name="Booking[email]"]', this).val(),
            units: $('#people6').val()
        });
        return false;
    });
    
    // Interceptor for Water World
    $('#waterworld-form').on('submit', function(e) {
        e.preventDefault();
        e.stopImmediatePropagation();
        
        const value = $(`#datereadonly8`).val();
        if (!value) { alert(`Please select a date`); return false; }
        ...
        handleBookingRedirect({
            ...
            phone: $('input[name="Booking[phone]"]', this).val(),
            email: $('input[name="Booking[email]"]', this).val(),
            below10: $('#people11').val(),
            above10: $('#people12').val()
        });
        return false;
    });
    
    // Interceptor for Water + Dry
    $('#waterdry-form').on('submit', function(e) {
        e.preventDefault();
        e.stopImmediatePropagation();
        
        const value = $(`#datereadonly88`).val();
        if (!value) { alert(`Please select a date`); return false; }
        ...
        handleBookingRedirect({
            ...
            phone: $('input[name="Booking[phone]"]', this).val(),
            email: $('input[name="Booking[email]"]', this).val(),
            below10: $('#people111').val(),
            above10: $('#people121').val()
        });
        return false;
    });
});
...
document.getElementById('booking-form').addEventListener('submit', function(e) {
    ...
    const value = $(`#datereadonly3`).val();
    if (!value) {
        alert(`Please select a date in field `);
        $(`#datereadonly3`).focus();
        e.preventDefault();
        return false;
    }
...
$(document).ready(function() {
    ...
    $('.book-now-btn').click(function(e) {
        ...
        if (token) {
            ...
            window.location.href = '<?= \Yii\helpers\Url::to(['client/book']) ?>' + '?product=' + productId;
        }
    });
});
</script>
