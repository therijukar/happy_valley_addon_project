  ...
  <div style="margin:200px 0px 200px 200px">
    <?php $form = ActiveForm::begin(['action' =>$action,'options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal','name' => 'payuForm']]); ?>
      ...
      <table>
        ...
        <tr hidden>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="https://gohappyvalley.com/booking/success" size="64" /></td>
          <!-- <td colspan="3"><input name="surl" value="http://baryon.in/HappyValley/booking/success" size="64" /></td> -->
        </tr>
        <tr hidden>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="https://gohappyvalley.com/booking/failure" size="64" /></td>
        </tr>
